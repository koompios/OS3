...
/*	License: GPLv3
	...
	Copyright: 2023
	Description: pix is a wrapper around apt to make it works inside a container
...
func init() {
	viper.AddConfigPath("/etc/pix/")
	viper.AddConfigPath("/usr/lib/pix/")
	...
	if err != nil {
		...
		Cnf = &Config{ContainerName: "pix_managed", Image: image, PkgManager: pkgmanager, DistroboxPath: "/usr/lib/pix/distrobox"}
	} else {
