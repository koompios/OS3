            ...
            dialog.connect('response', (widget, response) => {
                if (response === Gtk.ResponseType.YES) {
                    ...
                    for (let page of this._pages) {
                        ...
                        let keys = pageSettings.settings_schema.list_keys();
        ...
        deleteElementButton.connect('clicked', () => {
            ...
            dialog.connect('response', (_widget, response) => {
                if (response === Gtk.ResponseType.YES) {
                    ...
                    let keys = elementSettings.settings_schema.list_keys();
                    for (const key of keys)
    ...
    addPresetElement(title, widgetType, subtitle) {
        ...
        addButton.connect('clicked', () => {
            ...
            if (widgetType === ElementType.DATE) {
                ...
                let elementKeys = copyElementSettings.settings_schema.list_keys();
