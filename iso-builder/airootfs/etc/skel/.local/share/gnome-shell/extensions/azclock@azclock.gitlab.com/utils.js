...
function convertOldShadowValues(oldSettingName, newSetting, setValue, getElementData) {
    let shadowEnabled = getElementData(`${oldSettingName}Enabled`, 'bool');
    let shadowColor = getElementData(`${oldSettingName}Color`);
    let shadowX = getElementData(`${oldSettingName}X`, 'int');
    let shadowY = getElementData(`${oldSettingName}Y`, 'int');
    let shadowSpread = getElementData(`${oldSettingName}Spread`, 'int');
    let shadowBlur = getElementData(`${oldSettingName}Blur`, 'int');
